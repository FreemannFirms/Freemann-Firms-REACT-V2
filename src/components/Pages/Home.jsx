...
const HomePage = () => {
    ...
    return (
        <Layout>
            ...
            <div>
                <section ref={serviceRef} className="bg-cool mt-5">
                    <div>
                        <div className="py-6 px-12 border border-gray-200 bg-cool shadow-lg">
                            <div className="md:flex md:items-start md:-mx-4">
                                ...
                                <div className="mt-4 md:mx-4 md:mt-0">
                                    <h1 className="text-xl font-black text-gray-700 capitalize">Academy</h1>
                                </div>
                            </div>
                        ...
                        <div className="py-6 px-12 border border-gray-200 bg-cool shadow-lg">
                            <div className="md:flex md:items-start md:-mx-4">
                                ...
                                <div className="mt-4 md:mx-4 md:mt-0">
                                    <h1 className="text-xl font-black text-gray-700 capitalize">Earn</h1>
                                </div>
                            </div>
                            <div className="lg:px-16 py-2">
                                <p className="text-gray-500 py-2">
                        ...
                        <div className="py-6 px-12 border border-gray-200 bg-cool shadow-lg">
                            <div className="md:flex md:items-start md:-mx-4">
                                ...
                                <div className="mt-4 md:mx-4 md:mt-0">
                                    <h1 className="text-xl font-black text-gray-700 capitalize">Trade</h1>
                                </div>
                            </div>
                            <div className="lg:px-16 py-2">
                        ...
                        <div className="py-6 px-12 border border-gray-200 bg-cool shadow-lg">
                            <div className="md:flex md:items-start md:-mx-4">
                                ...
                                <div className="mt-4 md:mx-4 md:mt-0">
                                    <h1 className="text-xl font-black text-gray-700 capitalize">MarketPlace</h1>
                                </div>
                            </div>
                            <div className="lg:px-16 py-2">
                                <p className="text-gray-500 py-2">
                    ...
                    <div className="container flex flex-col p-2 md:p-6 mx-auto lg:py-16 lg:flex-row lg:items-center">
                        ...
                        <div className="w-full lg:w-1/2 px-1 md:px-4">
                            <div className="lg:max-w p-2 text-center">
                                <h1 className="text-3xl font-semibold tracking-wide text-gray-800 lg:text-4xl pb-3">
                                    About Us
                                </h1>
            ...
            <div ref={moreRef}>
                <section className="flex flex-col bg-white md:text-center p-4 md:items-center">
                    <div className="container p-2 text-center">
                        <h1 className="text-3xl font-semibold tracking-wide text-gray-800 lg:text-4xl">Our services</h1>
