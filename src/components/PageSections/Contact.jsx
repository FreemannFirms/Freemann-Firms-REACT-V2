        ...
        <motion.div ref={ref} animate={fade} variants={ComponentVariant} initial='hidden'>
            <section className="bg-white dark:bg-gray-900">
                <div className="container grid gap-8 px-6 py-12 mx-auto lg:grid-cols-3">
                    <div>
                        <p className="font-medium text-primaryColor dark:text-blue-400">Contact us</p>
                    ...
                    <div className="grid grid-cols-1 gap-12 lg:col-span-2 sm:grid-cols-2 ">
                        <div className="p-4 rounded-lg bg-cool md:p-6 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">freemannfirmsinfo@gmail.com</p>
                        </div>
                        ...
                        <div className="p-4 rounded-lg bg-cool md:p-6 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400"><a href="">Start new chat</a></p>
                        </div>
                        ...
                        <div className="p-4 rounded-lg bg-cool md:p-6 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">Warri, Nigeria</p>
                        </div>
                        ...
                        <div className="p-4 rounded-lg bg-cool md:p-6 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+(234) 81-0534-7598</p>
                        </div>
                    </div>
                </div>
            </section>
